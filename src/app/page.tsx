...
// Función auxiliar para mapear el string del ícono a un componente real
...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center pt-24 pb-16 bg-background text-foreground overflow-hidden">
      ...
      <section className="w-full max-w-6xl px-12 md:px-6">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            {/* Controles de navegación (Ocultos en pantallas muy pequeñas para evitar encimarse) */}
